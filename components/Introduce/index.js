    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.right}>
                ...
                <div className={styles.subtitle}>
                <div style={{ marginBottom:'14px' }}><span style={{color:'white', fontWeight:'bold'}}>Members of Lamar Odom's Metaverse</span> gain exclusive access to both virtual and physical experience including:</div>
